...
def reconstruct_3d_mesh(data, threshold=0):
    ...
    return verts, faces_pyvista, normals 

    
def visualize_3d_mesh_stretched_along_axis(verts, faces,normals , verts_mask,faces_mask, normals_mask , gap=0):
    """
    Visualizes the 3D mesh using PyVista with a small gap between slices.
    ...
    mesh = pv.PolyData(verts, faces,normals)
    mesh_mask = pv.PolyData(verts_mask , faces_mask,normals_mask)
...
def main():
    ...
    path_obj = r"C:\Users\Aggelos\ECE-2017-\Diplomatiki\data\3d_reconstruction_from_2d_slices\point_cloud.ply"
    # Example usage
    ...
    for threshold in [55]:
        ...
        verts, faces, normals= reconstruct_3d_mesh(data_3d, threshold=threshold)
        verts_mask ,faces_mask , normals_mask= reconstruct_3d_mesh(data_3d_mask, threshold= threshold)
        visualize_3d_mesh_stretched_along_axis(verts ,faces,normals ,verts_mask,faces_mask,normals_mask,gap = 5)
    ...
    # points_mask = array_to_point_cloud(data_3d_mask,threshold= 55)
