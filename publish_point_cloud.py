...
# from ament_index_python.packages import get_package_sahre_directory
# import os
...
class PointCloudPublisher(Node):
    def __init__(self):
        ...
        self.published_once = self.get_parameter('publish_once').get_parameter_value().bool_value
    ...
    def publish_point_cloud(self):
        ...
        try:
            ...
            #centering the point cloud to align with (0,0,0)
